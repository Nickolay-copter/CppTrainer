...
/*
1. Сначала необходимо определиться как будем использовать класс
Function - т.е. знаем какие методы и как будем использовать AddPart,
Invert, Applay 
*/
